...
function lib:init(ti, dosplash, visiblekey, deleteprevious)
 ...
 game:GetService("Debris"):AddItem(cg.ScreenGui, 1)
    ...
    if dosplash then
        ...
        splash.BackgroundColor3 = Color3.fromRGB(255, 255, 
 255)
    ...
    main.BackgroundColor3 = Color3.fromRGB(255, 
 255, 255)
 ...
 local notificon = Instance.new("ImageLabel")
    ...
    notifbutton1.Position = 
 UDim2.new(0.0559210554, 0, 0.817679524, 0)
 ...
 = UDim.new(0, 18)
   ...
   notif2title.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    ...
    notif2text.Position 
 = UDim2.new(0.0822368413, 0, 0.513812184, 0)
 ...
 UDim2.new(1.12, 0, 1.20000005, 0)
    ...
    function window:Notify(txt1, txt2, b1, icohn, callback)
        if notif.Visible == true or notif2.Visible == true then return "Already visible" 
 end
 ...
 then
        ...
        if mode then
                    ...
                    TextButton:TweenPosition(UDim2.new(0,1,0,1), "In", "Sine", 0.1, 
 true)
                    Frame.BackgroundColor3 = Color3.fromRGB(216, 216, 216)
                end
            end)
